 ...
 *  Maximum Value: can be anything.
 */
#define MS_NET_SEQ_NUMBER_BLOCK_SIZE                   2048
 ...
 *  Maximum Value: can be anything.
 */
#define PROXY_SUBNET_NETID_ADV_TIMEOUT               (100 | EM_TIMEOUT_MILLISEC)
 ...
 *  Maximum Value: can be anything.
 */
#define PROXY_SUBNET_NODEID_ADV_TIMEOUT              (100 | EM_TIMEOUT_MILLISEC)
 ...
 *  Maximum Value: can be anything.
 */
#define MS_REPLAY_CACHE_SIZE                           10
 ...
 *  Maximum Value: can be anything.
 */
#define MS_REASSEMBLED_CACHE_SIZE                     8
 ...
 *  Maximum Value: can be anything.
 */
#define LTRN_RTX_TIMEOUT                300 /* Millisecond */
