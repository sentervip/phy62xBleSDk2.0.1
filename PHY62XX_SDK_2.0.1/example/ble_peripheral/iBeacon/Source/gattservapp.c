...
//static uint8 gattServApp_PrepareWriteQInUse( void );//todo
...
//static gattServMsgCB_t s_GATTServCB = NULL;//todo
/*********************************************************************
...
// */
//bStatus_t GATTServApp_SetParameter( uint8 param, uint8 len, void *pValue )//todo
//{
...
// *          INVALIDPARAMETER: Invalid parameter
// */
//bStatus_t GATTServApp_GetParameter( uint8 param, void *pValue )//todo
//{
//  bStatus_t status = SUCCESS;
...
// *          FAILURE: Service not found.
// */
//bStatus_t GATTServApp_DelService( uint32 services )//todo
//{
//  uint8 status = SUCCESS;
...
// * @return  void
// */
//void GATTServApp_SetParamValue( uint16 value )//todo
//{
//#if defined ( TESTMODES )
//  paramValue = value;
//#else
...
// */
//uint16 GATTServApp_GetParamValue( void )//todo
//{
//#if defined ( TESTMODES )
//  return ( paramValue );
//#else
 ...
 * @return      none
 */
static void gattServApp_HandleConnStatusCB( uint16 connHandle, uint8 changeType )//todo
{
 ...
 * @return  none
 */
void GATTServApp_SendCCCUpdatedEvent( uint16 connHandle, uint16 attrHandle, uint16 value )//todo
{
