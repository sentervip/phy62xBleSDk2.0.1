...
/*
only comment the following features,if use please uncomment them.
SIMPLEPROFILE_CHAR7
...
static uint8 simpleProfileChar5[20];
...
//static uint8 simpleProfileChar7[20];
...
{
  NULL,//simpleProfile_ReadAttrCB,  // Read callback function pointer
  NULL,//simpleProfile_WriteAttrCB, // Write callback function pointer
...
bStatus_t SimpleProfile_GetParameter( uint8 param, void *value )
{
  ...
  switch ( param )
  {
    ...
    case SIMPLEPROFILE_CHAR5:
       VOID osal_memcpy( value, simpleProfileChar5, 20 );  
      break;    
//      
//    case SIMPLEPROFILE_CHAR7:
//       VOID osal_memcpy( value, simpleProfileChar7, 20 );  
//      break;         
