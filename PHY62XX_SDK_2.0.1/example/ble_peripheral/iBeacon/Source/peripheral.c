...
//          VOID GAPBondMgr_LinkEst( pPkt->devAddrType, pPkt->devAddr, pPkt->connectionHandle, GAP_PROFILE_PERIPHERAL);//todo
...
static void gapRole_HandleParamUpdateNoSuccess( void )
{
  ...
  {
//    case GAPROLE_RESEND_PARAM_UPDATE://todo
