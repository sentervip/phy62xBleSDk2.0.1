 ...
 *
 *
 * Module Name:	dongleKey 
 * File name:	dongleKey.h 
 * Brief description:
 *    key driver module
 * Author:	Eagle.Lao
 * Data:	2017-07-01
...
#ifndef __DONGLE_KEY_H__
#define __DONGLE_KEY_H__
...
typedef void (* key_callback_hdl_t)(uint8_t,key_evt_t);
...
typedef struct key_state{
	...
	uint8_t  				task_id;
	key_callback_hdl_t  key_callbank;
