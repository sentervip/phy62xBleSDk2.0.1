...
/**
 *  \file appl_sample_lpn_switch.c
 *
 *  Source File for Mesh SIG Model Client(OnOff/HSL/CTL/...) as LPN Standalone application 
 *  
 */
...
{
    /** UUID */
    {0x05, 0x04, 0x62, 0x12, 0x00, 0x02, 0x00, 0x01, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x00, 0x00},
...
API_RESULT UI_set_brr_scan_rsp_data (void)
{
    ...
    UCHAR UI_brr_scanrsp_data[] =
           ...
           */
           0x0f, 0x09, 'P', 'H', 'Y', '-', 'L', 'P', 'N', '-', 'S', 'W', 'I', 'T', 'C', 'H'
          };
    CONSOLE_OUT("\n Setting PHY-LPN-SWITCH as Complete Device Name!\n");
